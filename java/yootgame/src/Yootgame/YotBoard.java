...
public class YotBoard extends JFrame {
	...
	public YotBoard(PlayGame playObject) {
		...
		img[0] = new ImageIcon("./img/red.jpg"); // 1번 말 빨강
		img[1] = new ImageIcon("./img/blue.jpg");//2번 말 파랑
		img[2] = new ImageIcon("./img/green.jpg");//3번 말 초록
		img[3] = new ImageIcon("./img/yellow.jpg"); // 4번말 노랑
