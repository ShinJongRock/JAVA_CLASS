...
//    Image imgBdo = new Image(getClass().getResourceAsStream("dice1.png"));
    File file2 = new File("src/se_project/dice2.png"); 	// 도
    File file3 = new File("src/se_project/dice3.png");	// 개
    File file4 = new File("src/se_project/dice4.png");	// 걸
    File file6 = new File("src/se_project/dice6.png");	// 윷
    File file5 = new File("src/se_project/dice5.png");	// 모
    File file1 = new File("src/se_project/dice1.png");	// 백도
