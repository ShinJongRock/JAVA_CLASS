...
//    Image imgBdo = new Image(getClass().getResourceAsStream("dice1.png"));
    File file2 = new File("src/se_project/dice2.png"); 	// ?èÑ
    File file3 = new File("src/se_project/dice3.png");	// Í∞?
    File file4 = new File("src/se_project/dice4.png");	// Í±?
    File file6 = new File("src/se_project/dice6.png");	// ?ú∑
    File file5 = new File("src/se_project/dice5.png");	// Î™?
    File file1 = new File("src/se_project/dice1.png");	// Î∞±ÎèÑ
    ...
    @FXML private void rollYutButtonClicked(ActionEvent event) {
        ...
        // ?ú∑ Î≥¥Ïó¨Ï£ºÎäî ÏΩîÎìú ?ì§?ñ¥Í∞? Î∂?Î∂?
...
//        };
//        thread.start();
        if(yutResultList[yutResult].equals("?èÑ")) {
        	randomyoot.setImage(new Image(file2.toURI().toString()));
        }
        else if(yutResultList[yutResult].equals("Í∞?")) {
        	randomyoot.setImage(new Image(file3.toURI().toString()));
        }
        else if(yutResultList[yutResult].equals("Í±?")) {
        	randomyoot.setImage(new Image(file4.toURI().toString()));
        }
        else if(yutResultList[yutResult].equals("?ú∑")) {
        	randomyoot.setImage(new Image(file6.toURI().toString()));
        }
        else if(yutResultList[yutResult].equals("Î™?")) {
        	randomyoot.setImage(new Image(file5.toURI().toString()));
        }
        else if(yutResultList[yutResult].equals("ÎπΩÎèÑ")) {
