...
public class EchoClient {
	...
	public EchoClient(String ip, int port) throws IOException{
		...
		OutputStream os_oscket = tcpSocket.getOutputStream();
		InputStream is_socket = tcpSocket.getInputStream();
		
		BufferedWriter bufferW = new BufferedWriter(new OutputStreamWriter(os_oscket));
	...
	public static void main(String[] args) throws IOException {
		...
		new EchoClient("192.168.2.82", 5555); 
	}
